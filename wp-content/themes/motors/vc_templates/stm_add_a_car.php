...
if(!empty($use_inputs) and $use_inputs == 'yes') {
	$use_inputs = true;
} else {
	$use_inputs = false;
}
...
<?php if(!$car_edit): ?>
	<div class="stm_add_car_form<?php echo esc_attr($css_class); ?>">
		...
		<form method="POST" action="" enctype="multipart/form-data" id="stm_sell_a_car_form">
			...
			<?php if(!empty($show_car_title) and $show_car_title == 'yes'): ?>
				<div class="stm-car-listing-data-single stm-border-top-unit ">
					<div class="stm_add_car_title_form">
						<div class="title heading-font"><?php esc_html_e('Car title', 'motors'); ?></div>
						<input type="text" name="stm_car_main_title" placeholder="<?php esc_html_e('Title', 'motors'); ?>">
					</div>
				</div>
			<?php endif; ?>
				...
				<div class="stm-form-1-end-unit clearfix">
					<?php if(!empty($data)): ?>
						<?php foreach($data as $data_key => $data_unit):?>
							<?php if(!in_array($data_unit['slug'], $taxonomy)): ?>
							...
							<div class="row">
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
										...
										<input type="number" min="0" class="heading-font" name="stm_car_price" required/>
									</div>
								</div>
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
										<div class="stm_label heading-font"><?php esc_html_e('Sale Price', 'motors'); ?> (<?php echo stm_get_price_currency(); ?>)</div>
										<input type="number" min="0" class="heading-font" name="stm_car_sale_price" />
									</div>
								</div>
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
										<div class="stm_label heading-font"><?php esc_html_e('Custom label instead of price', 'motors'); ?></div>
										<input type="text" class="heading-font" name="car_price_form_label"/>
									</div>
								</div>
							</div>
						</div>
		...
		<form method="POST" action="" enctype="multipart/form-data" id="stm_sell_a_car_form">
			...
			<?php if(!empty($show_car_title) and $show_car_title == 'yes'): ?>
				<div class="stm-car-listing-data-single stm-border-top-unit ">
					<div class="stm_add_car_title_form">
						<div class="title heading-font"><?php esc_html_e('Car title', 'motors'); ?></div>
						<input type="text" name="stm_car_main_title" placeholder="<?php esc_html_e('Title', 'motors'); ?>" value="<?php echo esc_attr(get_the_title($item_id)); ?>">
					</div>
				</div>
			<?php endif; ?>
			<div class="stm_add_car_form_1">
						...
						<div class="row">
							<?php foreach($taxonomy as $tax): ?>
								...
								<div class="col-md-3 col-sm-3 stm-form-1-selects">
									...
									?>
									<?php if($number_field): ?>
										<?php $input_value = get_post_meta($item_id, $tax, true); ?>
										<input min="0" type="number" value="<?php echo esc_attr($input_value); ?>" name="stm_f_s[<?php echo esc_attr($tax); ?>]" required />
									<?php else: ?>
						...
						<div class="col-md-12 col-sm-12">
							<div class="row">
								...
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
										<div class="stm_label heading-font"><?php esc_html_e('Sale Price', 'motors'); ?> (<?php echo stm_get_price_currency(); ?>)</div>
										<input type="number" min="0" class="heading-font" name="stm_car_sale_price" value="<?php echo esc_attr($sale_price); ?>" />
									</div>
								</div>
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
